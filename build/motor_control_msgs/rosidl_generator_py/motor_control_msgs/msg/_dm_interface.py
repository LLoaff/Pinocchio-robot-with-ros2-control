...
class Metaclass_DmInterface(type):
    """Metaclass of message 'DmInterface'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('motor_control_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'motor_control_msgs.msg.DmInterface')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__dm_interface
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__dm_interface
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__dm_interface
            cls._TYPE_SUPPORT = module.type_support_msg__msg__dm_interface
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__dm_interface
...
class DmInterface(metaclass=Metaclass_DmInterface):
    """Message class 'DmInterface'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.dq = array.array('f', kwargs.get('dq', []))
    ...
    def dq(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'dq' array.array() must have the type code of 'f'"
            self._dq = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -3.402823466e+38 or val > 3.402823466e+38) or math.isinf(val) for val in value)), \
                "The 'dq' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._dq = array.array('f', value)
