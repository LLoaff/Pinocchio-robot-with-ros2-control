...
#include "motor_control_msgs/msg/detail/dm_interface__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_motor_control_msgs
cdr_serialize(
  const motor_control_msgs::msg::DmInterface & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motor_control_msgs::msg::DmInterface & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_motor_control_msgs
max_serialized_size_DmInterface(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_control_msgs::msg::DmInterface;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motor_control_msgs::msg::DmInterface *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_control_msgs::msg::DmInterface *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DmInterface__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const motor_control_msgs::msg::DmInterface *>(
...
static size_t _DmInterface__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DmInterface(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DmInterface__callbacks = {
...
static rosidl_message_type_support_t _DmInterface__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DmInterface__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_motor_control_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<motor_control_msgs::msg::DmInterface>()
{
  return &motor_control_msgs::msg::typesupport_fastrtps_cpp::_DmInterface__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_control_msgs, msg, DmInterface)() {
  return &motor_control_msgs::msg::typesupport_fastrtps_cpp::_DmInterface__handle;
}
